...
<div class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative rounded-2xl overflow-hidden group cursor-pointer" data-aos="fade-up">
            <img src="assets\img_web\tips diet.jpg" alt="Featured Post" class="w-full h-[600px] object-cover transform group-hover:scale-105 transition-transform duration-700">
                ...
                <div class="max-w-3xl">
                    ...
                    <div class="flex items-center space-x-6 text-white/80">
                        <div class="flex items-center space-x-2">
                            <img src="assets\img_web\tes.jpg" alt="Author" class="w-10 h-10 rounded-full border-2 border-red-400">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group blog-card bg-white rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-1 transition-all duration-300" 
                ...
                <div class="relative h-64 overflow-hidden">
                    <img src="assets\img_web\motivasi.jpg" alt="{{ $post['title'] }}" 
